...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-md-offset-3">
        ...
        <br /><br />
        <asp:RequiredFieldValidator ID="RequiredTitle" runat="server" ErrorMessage="Title is required"
             Display="None" SetFocusOnError="true" ForeColor="Firebrick" ControlToValidate="EditTitle">
        </asp:RequiredFieldValidator>
         <asp:RequiredFieldValidator ID="RequiredReleaseYear" runat="server" ErrorMessage="Release Year is required"
             Display="None" SetFocusOnError="true" ForeColor="Firebrick" ControlToValidate="EditReleaseYear">
        </asp:RequiredFieldValidator>
<%--    One could include the CompareValidator to first ensure that the entered value is of the DataType: Integer
        However, the RangeValidator does have a Type property which can be set to do the CompareValidator's job
            of ensuring the datatype is an integer.
        <asp:CompareValidator ID="CompareReleaseYear" runat="server" ErrorMessage="Release Year must be 1950 to today"
            Display="None" SetFocusOnError="true" ForeColor="Firebrick" ControlToValidate="EditReleaseYear"
            Type="Integer" Operator="DataTypeCheck"></asp:CompareValidator>--%>

<%--    The MaximumValue property is set within the Page_Load method. The property is set to the current year. Remember,
            is a control, just like any other control; the only difference is that it is not displayed. One can
            interact with a control in the code-behind. --%>
        <asp:RangeValidator ID="RangeReleaseYear" runat="server" ErrorMessage="Release Year must be 1950 to today"
            Display="None" SetFocusOnError="true" ForeColor="Firebrick"
            MinimumValue="1950"  ControlToValidate="EditReleaseYear" Type="Integer">
        </asp:RangeValidator>
